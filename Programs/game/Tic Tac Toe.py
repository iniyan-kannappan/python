...
while True:
    ...
    while True:
        try:
            ...
            pick=(int(input()))
            while numbers[pick]=='O' or numbers[pick]=='X':
                print('This number is already is occupied.')
                print('Please enter a new number.')
                pick=(int(input()))
            numbers[pick]='O'
